...
# train RBM
model_rbm.train(X=train_set_x, X_validate=test_set_x, batch_size=batch_size, pcdk=pcdk, NS=NS, maxiter=maxiter, learn_rate_a=learn_rate_a, learn_rate_b=learn_rate_b, learn_rate_W=learn_rate_W, change_rate=change_rate, adjust_change_rate_at=adjust_change_rate_at, adjust_coef=adjust_coef, reg_lambda_a=reg_lambda_a, reg_alpha_a=reg_alpha_a, reg_lambda_b=reg_lambda_b, reg_alpha_b=reg_alpha_b, reg_lambda_W=reg_lambda_W, reg_alpha_W=reg_alpha_W, change_every_many_iters=change_every_many_iters, init_chain_time=init_chain_time, train_subset_size_for_compute_error=100, valid_subset_size_for_compute_error=100, track_reconstruct_error=True, track_free_energy=True, reinit_a_use_data_stat=reinit_a_use_data_stat, if_plot_error_free_energy=True, dir_save=dir_save, prefix=prefix, figwidth=5, figheight=3)
